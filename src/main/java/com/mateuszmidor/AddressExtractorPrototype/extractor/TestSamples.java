...
/**
 * This class is basically a collection of test samples. It allows to read test
 * samples from file/save samples to file.
 * 
 * @author mateusz
 */
public class TestSamples extends LinkedList<TestSample> {
	...
	public static TestSamples fromFile(final String filename)
			throws IOException {
	...
	public void removeNotMatching(String regexp) {
		...
		while (it.hasNext()) {
			removeIfNotMatching(it, p);
		}
	}

	private void removeIfNotMatching(Iterator<TestSample> it, Pattern p) {
